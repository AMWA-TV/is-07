...
There is no change or addition required from the IS-04 v1.2 schema but additional controls will be added to the `controls` array for Websocket transport and for the Event & Tally REST API (see [Websocket transport](4.2.%20Transport%20-%20Websocket.md) and [Event & Tally REST API](5.0.%20Event_and_tally_rest_api.md)).
...
The usage will be detailed in each transport section and in the [Event & Tally REST API](5.0.%20Event_and_tally_rest_api.md) section.
